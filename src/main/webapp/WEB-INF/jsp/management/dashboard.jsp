                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li id="user" class="active"><a href="${pageContext.request.contextPath}/management/dashboard"><i class="fa fa-th-list"></i> Dashboard</a></li>
                            <li><a href="${pageContext.request.contextPath}/management/viewreports"><i
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="row tile_count"  id="dashboard">
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    ...
                                                    <div class="count green">${allcreatedusers}</div>
                                                ...
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    ...
                                                    <div class="count green">${unverifiedusers}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Rejected Users</span>
                                                    <div class="count green">${rejectedusers}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Created Riders</span>
                                                    <div class="count green">${allcreatedriders}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Verified Riders</span>
                                                    <div class="count green">${verifiedriders}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Unverified Riders</span>
                                                    <div class="count green">${unverifiedriders}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Rejected Riders</span>
                                                    <div class="count green">${rejectedriders}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Registered Tricycles</span>
                                                    <div class="count green">${numberofkeke}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Registered Bus</span>
                                                    <div class="count green">${numberofBus}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                    <span class="count_top"><i class="fa fa-user"></i> Registered Motorcycles</span>
                                                    <div class="count green">${numberofMotorcycle}</div>
                                                    <%--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                                                </div>
                                                <%--<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">--%>
                                                    <%--<span class="count_top"><i class="fa fa-user"></i> Total Active Users</span>--%>
                                                    <%--<div class="count green">2,500</div>--%>
                                                    <%--&lt;%&ndash;<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>&ndash;%&gt;--%>
                                                <%--</div>--%>
                                            </div>
                                            <!-- /top tiles -->
                                        </div>
