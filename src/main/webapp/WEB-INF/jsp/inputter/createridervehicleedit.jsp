                            ...
                            <div class="row">
                                <div class="col-md-12 col-md-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <br/>
                                            <form method="post" action="/inputter/updateridervehicle"
                                                ...
                                                <input type="hidden" name="vehuniqueid" value="${veh.id}"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                                                        <select type="select" name="vehtype" class="form-control select"
                                                                id="vehtype" required vehtype="${veh.vehicleType}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="platenumber"
                                                               ...
                                                               placeholder="Plate Number" required value="${veh.vehiclePlateNumber}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="enginenumber"
                                                               ...
                                                               placeholder="Engine Number" required value="${veh.vehicleEngineNumber}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="chassis"
                                                               ...
                                                               placeholder="Last Name" required value="${veh.vehicleChassisNumber}">
                                                        <span class="fa fa-edit form-control-feedback left"
                                                              aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="manname"
                                                               ...
                                                               placeholder="e.g. Honda, Suzuki" required value="${veh.vehicleManufacturerName}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="model"
                                                               ...
                                                               placeholder="" required value="${veh.vehicleModel}">
                                                        <span class="fa fa-bus form-control-feedback left"
                                                              aria-hidden="true"></span>
                                                    </div>
                                                </div>
