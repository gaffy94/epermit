    ...
    <div class="main_container">
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li id="user"><a href="${pageContext.request.contextPath}/inputter/dashboard"><i class="fa fa-th-list"></i> Dashboard</a></li>
                            <li class="active"><a href="${pageContext.request.contextPath}/inputter/createriderdetailspage"><i
        ...
        <div class="right_col" role="main">
            <div class="col-sm-12">
                ...
                <%--start here--%>
                <form method="post" action="\inputter\updateriderdetails">
                    <div class="row">
                        <div class="col-md-6 col-md-6">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <strong>User Unique Code : ${user.riderUniqueCode}</strong>
                                    <input type="hidden" name="useruniquecode" value="${user.riderUniqueCode}"/>
                                </div>
                            </div>
                            <div class="x_panel">
                                <div class="x_title">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-horizontal form-label-left input_mask" name="rider" id="rider">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input name="firstname" class="form-control has-feedback-left"
                                                       id="firstname" placeholder="First Name" required="" type="text" value="${user.riderFirstname}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input name="middlename" class="form-control has-feedback-left"
                                                       ...
                                                       type="text" value="${user.riderOtherNames}">
                                                <span class="fa fa-user form-control-feedback left"
                                                      aria-hidden="true"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input name="surname" class="form-control has-feedback-left"
                                                       id="surname"
                                                       placeholder="Last Name" required="" type="text" value="${user.riderSurname}">
                                                <span class="fa fa-user form-control-feedback left"
                                                      aria-hidden="true"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="${user.riderGender}" id="rgender"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input name="dob" class="form-control has-feedback-left" id="dob"
                                                       required="" type="date" value="${user.riderDateOfBirth}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input name="email" class="form-control has-feedback-left"
                                                       ...
                                                       type="email" value="${user.riderEmail}">
                                                <span class="fa fa-user form-control-feedback left"
                                                      aria-hidden="true"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input name="phonenumber" class="form-control has-feedback-left"
                                                       ...
                                                       type="text" value="${user.riderPhonenumber}">
                                                <span class="fa fa-user form-control-feedback left"
                                                      aria-hidden="true"></span>
                                            </div>
                                        </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                            <input name="address" class="form-control has-feedback-left"
                                                   id="address"
                                                   placeholder="Street/Area" required="" type="text" value="${user.riderAddress}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                            <select type="text" name="state" class="form-control select" id="state"
                                                    required="" state="${user.riderStateOfOrigin}">
                                    ...
                                    <div class="form-group">
                                        <label for="lga" class="control-label col-md-3 col-sm-3 col-xs-12">Local
                                            Govt</label>
                                        <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                            <select name="lga" class="form-control select" id="lga" lga="${user.riderLocalGovt}">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <img id="screenshot-img" width="250" height="300" src="${user.riderImageData}">
                                        </div>
                                    </div>
                                    <input type="hidden" name="image" id="userimg" value="${user.riderImageData}"/>
