                        ...
                        <div id="mainContent" class="dashboard_graph">
                            <div class="row">
                                <div class="col-md-12 col-md-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-cc-mastercard"></i> Verify Payment</h2>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form method="post" action="${pageContext.request.contextPath}/inputter/confirmpayment" class="form-horizontal form-label-left input_mask" name="rider" id="rider">

                                                <div class="form-group">
                                                    <label for="surname" class="control-label col-md-3 col-sm-3 col-xs-12">Surname</label>
                                                    <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="surname" class="form-control has-feedback-left" id="surname" placeholder="Enter Surname" required>
                                                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="idNumber" class="control-label col-md-3 col-sm-3 col-xs-12"> Teller Number </label>
                                                    <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                                        <input type="text" name="tellernumber" class="form-control has-feedback-left" id="idNumber" placeholder="Payment ID" required>
